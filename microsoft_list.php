...
$userUsername = $_SESSION['loggedInUser'];
	...
	echo "</ul>";
	echo "</div>";
echo "<center><img src='microsoft.jpg' align='middle'></center>";
...
echo "<table id='myTable' table border='1' class='tablesorter table'>
<thead> 
    <tr>
		<th width='5%' id='ID'>ID</th>
...
$dbc = mysqli_connect('localhost', 'Dnoop', $password, 'gametogether');
$result = mysqli_query($dbc, "SELECT * FROM requestpost WHERE consol='Xbox' OR consol='Xbox 360' OR consol='Xbox One' ORDER BY indexID DESC");
//$result = mysqli_query($dbc, "SELECT * FROM requestpost ORDER BY index DESC WHERE consol='Xbox' OR consol='Xbox 360' OR consol='Xbox One'");
