...
$result = mysqli_query($dbc, "SELECT * FROM requestpost WHERE consol='Steam' OR consol='Origin' OR consol='Facebook' OR consol='PC Game'");
...
<thead> 
    <tr>
        ...
        <th width='6%' id='Consol'>Website/Application</th>
